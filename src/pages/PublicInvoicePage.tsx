                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gradient-to-r from-slate-800 to-slate-700">
                      <th className="text-left text-xs font-bold text-white/90 uppercase tracking-wider py-4 px-5 w-3/4">Description</th>
                      {invoiceData?.invoice_type === 'equipment' && (
                        <>
                          ...
                          <th className="text-right text-xs font-bold text-white/90 uppercase tracking-wider py-4 px-5 whitespace-nowrap">Rate</th>
                        </>
                      )}
