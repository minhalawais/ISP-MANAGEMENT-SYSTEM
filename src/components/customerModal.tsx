  ...
  return (
    ...
    >
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div 
          className="fixed inset-0 bg-[#89A8B2] bg-opacity-30 transition-opacity" 
          aria-hidden="true"
          onClick={onClose}
          style={{ height: '421%', width: '100%' }}
        />
        
        <div className="inline-block align-bottom bg-[#F1F0E8] rounded-xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full animate-modal" style={{ width: '80%', maxWidth: '80%' }}>
