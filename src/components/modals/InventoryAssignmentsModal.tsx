  ...
  const fetchAssignments = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `http://mbanet.com.pk/api/inventory/assignments?inventory_item_id=${inventoryItemId}`,
        {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axiosInstance.post(
        "http://mbanet.com.pk/api/inventory/assignments/add",
  ...
  const handleReturn = async (assignmentId: string) => {
    try {
      ...
      await axiosInstance.put(
        `http://mbanet.com.pk/api/inventory/assignments/return/${assignmentId}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        },
