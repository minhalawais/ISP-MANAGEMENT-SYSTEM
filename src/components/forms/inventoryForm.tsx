...
import { Box, Barcode, ClipboardList, Truck, CheckCircle, Package, DollarSign, Hash } from "lucide-react"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="available" className={statusColors.available}>
                Available
              </option>
              <option value="assigned" className={statusColors.assigned}>
                Assigned
              </option>
              <option value="maintenance" className={statusColors.maintenance}>
                Maintenance
              </option>
            </select>
