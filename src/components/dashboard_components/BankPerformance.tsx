        ...
        <table className="w-full table-fixed text-sm">
          <thead className="text-left text-gray-600">
            <tr className="border-b border-gray-200">
              ...
              <th className="py-2 px-3 w-1/7">Initial Balance</th>
              <th className="py-2 px-3 w-1/7">Adjusted Balance</th>
          ...
          <tbody className="text-gray-900">
            ...
            {(data && data.length > 0) && (
              <tr className="border-t-2 border-gray-300 bg-gray-50 font-semibold">
                ...
                <td className={`py-2 px-3 ${(bankTotals?.adjusted_balance || 0) >= 0 ? "text-indigo-800" : "text-red-800"}`}>
      ...
      <div className="mt-4 space-y-2">
        ...
        <div className="p-3 bg-purple-50 border border-purple-200 rounded-lg">
          <p className="text-sm text-purple-700">
            <strong>Adjusted Balance:</strong> Represents the net position after considering initial bank balances and transaction flows. 
            This shows the actual financial position of each account.
          </p>
        </div>
      </div>
    </div>
