  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/employee_portal/customer-management" element={<PrivateRoute element={<CustomerManagementForEmployee/>} />} />
        <Route path="/employee_portal/complaint-handling" element={<PrivateRoute element={<EmployeeComplaintManagement/>} />} />
        <Route path="/employee_portal/task-management" element={<PrivateRoute element={<EmployeeTaskManagement/>} />} />
        <Route path="/employee_portal/recovery-task-management" element={<PrivateRoute element={<EmployeeRecoveryTaskManagement/>} />} />
        <Route path="/employee_portal/service-plans" element={<PrivateRoute element={<EmployeeServicePlanManagement/>} />} />
        <Route path="/employee_portal/payments-management" element={<PrivateRoute element={<EmployeePaymentManagement/>} />} />
        <Route path="/employee_portal/inventory-management" element={<PrivateRoute element={<EmployeeInventoryManagement/>} />} />
        <Route path="/employee_portal/invoices-management" element={<PrivateRoute element={<EmployeeInvoiceManagement/>} />} />
      </Routes>
    </Router>
  );
};
